...
class Category extends Validate
{
    ...
    protected $rule = [
        ...
        'catdir' => 'require|unique:category',
        'image' => 'number',
        'config_group' => 'require|alpha',
    ...
    protected $message = [
        ...
        'config_group.require' => '配置项分组不得为空',
        'config_group.alpha' => '配置项分组只能为字母',
    ...
    protected $scene = [
        ...
        'config' => ['parentid', 'type', 'catname', 'catdir', 'image', 'listorder', 'status', 'config_group'],
    ];
}
